...
async function createScene(canvas) {
    ...
    var default_pipeline = new BABYLON.DefaultRenderingPipeline(
        "default_pipeline", // The name of the pipeline
    ...
    const shadow_generator = new BABYLON.ShadowGenerator(4096, light)
    ...
    BABYLON.SceneLoader.ImportMesh("", "assets/graphics/vehicles/glb_test/", "A87_M44.glb", scene, (meshes) => {
        meshes.forEach(node => {
            if(node.material){
                ...
                node.material.environmentIntensity = 0
                //node.material.ambientTexture = undefined
